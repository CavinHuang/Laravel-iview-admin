...
var update = __webpack_require__(3)("dae9493e", content, false);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(3)("597a8531", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__libs_http__ = __webpack_require__(19);
//
//
//
//
        ...
        handleSubmit: function handleSubmit() {
            ...
            this.$refs.loginForm.validate(function (valid) {
                if (valid) {
                    ...
                    __WEBPACK_IMPORTED_MODULE_1__libs_http__["a" /* default */].post('/api/auth/login', _this.form).then(function (res) {
                        console.log(res);
                    });
