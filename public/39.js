...
var update = __webpack_require__(6)("72487624", content, false);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__expandRow_vue__ = __webpack_require__(687);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(6)("5450a73c", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
